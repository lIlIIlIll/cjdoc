...
for schema_name in doc-ir doc-ir-v6 doc-ir-v7 doc-ir-v8 diagnostics cfg-matrix search-index api-surface documentation-coverage documentation-quality; do
